...
// include: /tmp/tmpakdru5yv.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/HellDefender.data';
      var REMOTE_PACKAGE_BASE = 'HellDefender.data';
...
Module['FS_createPath']("/assets/images", "decorations", true, true);
Module['FS_createPath']("/assets/images", "enemies", true, true);
Module['FS_createPath']("/assets/images", "letterings", true, true);
Module['FS_createPath']("/assets/images", "tower", true, true);
Module['FS_createPath']("/assets/images/tower", "tower_attack", true, true);
Module['FS_createPath']("/assets/images", "window", true, true);
Module['FS_createPath']("/assets", "sounds", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/HellDefender.data');

      };
      Module['addRunDependency']('datafile_build/HellDefender.data');
    ...
    loadPackage({"files": [{"filename": "/assets/images/decorations/fire.png", "start": 0, "end": 713}, {"filename": "/assets/images/enemies/eye_of_truth.png", "start": 713, "end": 1777}, {"filename": "/assets/images/enemies/ghost.png", "start": 1777, "end": 2248}, {"filename": "/assets/images/enemies/reaper.png", "start": 2248, "end": 2716}, {"filename": "/assets/images/enemies/skeleton.png", "start": 2716, "end": 3922}, {"filename": "/assets/images/enemies/spider.png", "start": 3922, "end": 4651}, {"filename": "/assets/images/letterings/title_lettering.png", "start": 4651, "end": 6032}, {"filename": "/assets/images/tower/tower.png", "start": 6032, "end": 6701}, {"filename": "/assets/images/tower/tower_attack/tower_attack_active.png", "start": 6701, "end": 7298}, {"filename": "/assets/images/tower/tower_attack/tower_attack_unnactive.png", "start": 7298, "end": 8011}, {"filename": "/assets/images/window/icon.png", "start": 8011, "end": 8313}, {"filename": "/assets/sounds/background_music.wav", "start": 8313, "end": 5642581, "audio": 1}, {"filename": "/assets/sounds/enemy_damage.wav", "start": 5642581, "end": 5649769, "audio": 1}], "remote_package_size": 5649769});

  })();

// end include: /tmp/tmpakdru5yv.js
// include: /tmp/tmpxiauuk3e.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpxiauuk3e.js
// include: /tmp/tmpqb_o7z4k.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpqb_o7z4k.js
...
function findWasmBinary() {
    return locateFile('HellDefender.wasm');
}
...
var ASM_CONSTS = {
  142536: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 144694: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 144858: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 144962: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 145133: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 147961: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 148027: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 148420: ($0) => { miniaudio.untrack_device_by_index($0); },  
 148463: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 148588: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 148714: () => { if (document.fullscreenElement) return 1; },  
 148760: () => { return Module.canvas.width; },  
 148792: () => { return parseInt(Module.canvas.style.width); },  
 148840: () => { document.exitFullscreen(); },  
 148867: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 148940: () => { if (document.fullscreenElement) return 1; },  
 148986: () => { return Module.canvas.width; },  
 149018: () => { return screen.width; },  
 149043: () => { document.exitFullscreen(); },  
 149070: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 149203: () => { return window.innerWidth; },  
 149229: () => { return window.innerHeight; },  
 149256: () => { if (document.fullscreenElement) return 1; },  
 149302: () => { return Module.canvas.width; },  
 149334: () => { return parseInt(Module.canvas.style.width); },  
 149382: () => { if (document.fullscreenElement) return 1; },  
 149428: () => { return Module.canvas.width; },  
 149460: () => { return screen.width; },  
 149485: () => { return window.innerWidth; },  
 149511: () => { return window.innerHeight; },  
 149538: () => { if (document.fullscreenElement) return 1; },  
 149584: () => { return Module.canvas.width; },  
 149616: () => { return screen.width; },  
 149641: () => { document.exitFullscreen(); },  
 149668: () => { if (document.fullscreenElement) return 1; },  
 149714: () => { return Module.canvas.width; },  
 149746: () => { return parseInt(Module.canvas.style.width); },  
 149794: () => { document.exitFullscreen(); },  
 149821: ($0) => { Module.canvas.style.opacity = $0; },  
 149859: () => { return screen.width; },  
 149884: () => { return screen.height; },  
 149910: () => { return window.screenX; },  
 149937: () => { return window.screenY; },  
 149964: () => { return window.devicePixelRatio; },  
 150000: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 150053: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 150104: () => { Module.canvas.style.cursor = 'none'; },  
 150141: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 150397: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 150448: () => { if (document.fullscreenElement) return 1; },  
 150494: () => { return window.innerWidth; },  
 150520: () => { return window.innerHeight; },  
 150547: () => { if (document.pointerLockElement) return 1; }
};
